            ...
            <div className="flex justify-between items-center mb-4">
             ...
             <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-1 gap-8">
                 ...
                 <div className="mt-8" data-tour="heat-map">
                ...
                if (subCatAvg < 3.5) {
                    subCatMetricsWithScores.forEach(({ metric, score }) => {
                        if (score <= 3) {
                            ...
                            // If a specific negative phrasing exists, use it. Otherwise, create a clear one.
                            // This ensures ALL low-scoring metrics are listed as challenges.
                            challenges.push({
                                subCategory: subCat.name,
                                text: challengeText || `בית הספר מתמודד עם אתגר בתחום: ${metric.name}`
                            });
                        }
                    });
                }
        ...
        <div className="space-y-6">
            ...
            {view === 'schools' && (
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                    ...
                    <div ref={schoolReportContainerRef} className="bg-white p-6 rounded-lg shadow-md xl:col-span-2" data-tour="school-reports">
                         <div className="flex justify-between items-center mb-4">
