...
import { getTourStepsForStep } from '../data/tourSteps';
...
const FileUploadAnalyzer: React.FC = () => {
    ...
    const FileUploadStep = () => (
        <div className="max-w-4xl mx-auto p-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200" data-tour="file-upload">
                <div className="text-center mb-8">
    ...
    const renderCurrentStep = () => {
        switch (currentStep) {
            ...
            case 'data-mapping':
                return <div data-tour="data-mapping"><Step1_DataMapping schools={schoolsData} setSchools={setSchoolsData} onComplete={handleDataMappingComplete} onReset={handleReset} /></div>;
            case 'analysis':
                return (
                    <div className="max-w-7xl mx-auto p-4 md:p-8" data-tour="analysis-overview">
                        <DynamicDataAnalyzer schoolsData={schoolsData} onAnalysisComplete={handleAnalysisComplete} />
                    </div>
                );
            case 'focus-area-selection':
                return (
                    <div className="max-w-7xl mx-auto p-4 md:p-8" data-tour="focus-areas">
                        {analysisData && (
            ...
            case 'issue-selection':
                 return (
                    <div className="max-w-7xl mx-auto p-4 md:p-8" data-tour="issue-selection">
                        {analysisData && (
                            <IssueSelectionStep
            ...
            case 'mtss-tiering':
                 return (
                    <div className="max-w-7xl mx-auto p-4 md:p-8" data-tour="mtss-tiering">
                        {analysisData && (
                            <MTSS_TieringStep
                                analysisData={analysisData}
            ...
            case 'supervisor-goals':
                return (
                    <div className="max-w-7xl mx-auto p-4 md:p-8" data-tour="supervisor-goals">
            ...
            case 'plan':
                return (
                    <div className="max-w-7xl mx-auto p-4 md:p-8" data-tour="intervention-plans">
    ...
    const tourSteps = getTourStepsForStep(currentStep);
        ...
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="fixed top-4 right-4 z-40">
                <button
                    ...
                    title="התחל סיור וירטואלי"
                >
                    <HelpCircle className="w-5 h-5" />
                    <span className="hidden sm:inline">סיור וירטואלי</span>
                </button>
            </div>
