...
export const METRIC_TO_CHALLENGE_MAP: { [key: string]: string } = {
    'vision_clearAndAgreedScore': 'החזון הבית ספרי אינו ברור או מוסכם דיו על כלל הצוות.',
    'vision_educationalConceptTranslatedScore': 'התפיסה החינוכית אינה מתורגמת באופן עקבי לעקרונות פעולה ברורים.',
    'vision_resourcesAndEdgesScore': 'החזון אינו מתבסס על ניצול המשאבים והיתרונות היחסיים של בית הספר.',
    'vision_strategicPlanningScore': 'בית הספר אינו פועל על פי תכנון אסטרטגי ארוך טווח.',
    'vision_measurableGoalsScore': 'היעדים הנגזרים מהחזון אינם מדידים או ניתנים להערכה.',
    'vision_communityPartnershipScore': 'הקהילה אינה שותפה מספיק בעיצוב ובקידום החזון הבית ספרי.',
    ...
    'managementTeam_teamworkBasedScore': 'עבודת צוות ההנהלה אינה מתבססת על שיתוף פעולה ואמון.',
    'managementTeam_clearRolesScore': 'הגדרות התפקידים ותחומי האחריות בצוות ההנהלה אינן ברורות דיין.',
    'managementTeam_middleLeadershipInvolvedScore': 'מנהיגות הביניים (רכזים) אינה שותפה באופן מלא בהובלת בית הספר.',
    'managementTeam_roleHoldersCoachingScore': 'בעלי תפקידים בצוות ההנהלה אינם מקבלים ליווי ותמיכה לפיתוחם המקצועי.',
    'managementTeam_dataBasedDecisionsScore': 'תהליכי קבלת ההחלטות בצוות ההנהלה אינם מבוססים על נתונים.',
    'managementTeam_teacherCollaborationScore': 'צוות ההנהלה אינו מוביל ומעודד שיתופי פעולה בקרב המורים.',
    ...
    'staffLearning_adaptedProfessionalDevelopmentScore': 'הפיתוח המקצועי אינו מותאם לצרכים האישיים והמערכתיים.',
    'staffLearning_connectingDevelopmentToPracticeScore': 'אין קיים חיבור הדוק בין הפיתוח המקצועי ליישום בשטח.',
    'staffLearning_subjectAreaTrainingScore': 'הצוות אינו מקבל הדרכה מקצועית ועדכנית בתחומי הדעת השונים.',
    'staffLearning_peerLearningCultureScore': 'אין קיימת תרבות של למידת עמיתים, שיתוף ידע ושיח פתוח.',
    'staffLearning_innovativeInitiativesScore': 'בית הספר אינו מעודד ומטפח יוזמות חדשניות בקרב הצוות.',
    'staffLearning_highExpectationsOfAchievementsScore': 'לצוות אין ציפיות גבוהות מהישגי התלמידים בכל התחומים.',
    'staffWellbeing_teachersReceiveSupportScore': 'מורים אינם זוכים לליווי, תמיכה ומשוב מקדם מההנהלה.',
    'staffWellbeing_structuredOnboardingProcessesScore': 'אין קיימים תהליכי קליטה מובנים ותומכים למורים חדשים.',
    'staffWellbeing_wellbeingAndResilienceSupportScore': 'בית הספר אינו מספק מענים לרווחת ולחוסן הנפשי של המורים.',
    'staffWellbeing_cohesionBuildingActivitiesScore': 'אין מתקיימות פעילויות לחיזוק הלכידות והגיבוש הצוותי.',
    'staffWellbeing_highStaffStabilityScore': 'יציבות הצוות החינוכי נמוכה, ותחלופת המורים גבוהה.',
    'staffWellbeing_highSatisfactionScore': 'שביעות הרצון של המורים ממקום עבודתם נמוכה.',
    'routines_adaptedTimetableScore': 'מערכת השעות אינה מותאמת ליעדים הפדגוגיים ואינה תומכת בגמישות.',
    'routines_orderlyMeetingRoutinesScore': 'שגרות הישיבות בבית הספר אינן סדורות, יעילות וממוקדות.',
    'routines_decisionMakingProcessesScore': 'תהליכי קבלת ההחלטות בבית הספר אינם שקופים וברורים לכלל הצוות.',
    'resources_systematicAllocationScore': 'הקצאת המשאבים (תקציב, שעות) אינה נעשית באופן שיטתי בהתאם ליעדים.',
    'resources_resourceUtilizationTrackingScore': 'אין קיים מעקב אחר ניצול אפקטיבי של המשאבים.',
    'resources_controlAndImprovementScore': 'אין מתקיימים תהליכי בקרה ושיפור מתמידים בניהול המשאבים.',
    'climateMapping_climateDataAnalysisScore': 'בית הספר אינו מנתח באופן שיטתי את נתוני האקלים.',
    'climateMapping_monitoringAndEvaluationRoutinesScore': 'אין קיימות שגרות למעקב והערכה של האקלים הבית ספרי.',
    'climateMapping_detectionAndTreatmentMechanismsScore': 'אין קיימים מנגנונים לאיתור וטיפול בתלמידים בסיכון.',
    'climateSafety_proceduresAndRulesEnforcedScore': 'הנהלים והכללים אינם נאכפים באופן עקבי וברור.',
    'climateSafety_safetyReinforcementProgramsScore': 'אין מופעלות תוכניות לחיזוק תחושת המוגנות של התלמידים.',
    'climateSafety_socialActivitiesScore': 'אין מתקיימות פעילויות חברתיות המקדמות לכידות ושייכות.',
    'climateSafety_fewViolenceIncidentsScore': 'אירועי האלימות בבית הספר אינם מצומצמים ומטופלים ביעילות.',
    'climateSafety_recognitionAndAppreciationCultureScore': 'אין קיימת תרבות של הכרה והוקרה התורמת לתחושת הערך העצמי.',
    'climateRelationships_personalSocialEmotionalDialogueScore': 'אין מתקיים שיח אישי, רגשי וחברתי בין מורים לתלמידים.',
    'climateRelationships_familiarityAndPersonalConnectionScore': 'המורים אינם מכירים היטב את תלמידיהם ואינם מקיימים עמם קשר אישי.',
    'climateRelationships_teacherToolsAndCoachingScore': 'למורים אין כלים וליווי לפיתוח קשר אישי עם תלמידים.',
    'climateRelationships_optimalSocialAtmosphereScore': 'האווירה החברתית בבית הספר אינה מיטבית ותומכת.',
    'sel_lifeSkillsProgramScore': 'אין מופעלת תוכנית כישורי חיים המפתחת מיומנויות רגשיות-חברתיות.',
    'sel_parentalConnectionScore': 'אין מתקיים קשר רציף עם ההורים בנושאים רגשיים וחברתיים.',
    'sel_diverseSupportOptionsScore': 'בית הספר אינו מציע מגוון מענים לטיפול בקשיים רגשיים והתנהגותיים.',
    'language_adequateReadingComprehensionScore': 'רמת הבנת הנקרא של התלמידים אינה מספקת.',
    'language_developedWritingSkillsScore': 'כישורי כתיבה של התלמידים אינם מפותחים היטב.',
    'language_broadVocabularyScore': 'לתלמידים אין אוצר מילים רחב ועשיר.',
    'language_clearOralExpressionScore': 'יכולת הביטוי בעל פה של התלמידים אינה ברורה ורהוטה.',
    'language_establishedReadingCultureScore': 'אין קיימת תרבות קריאה מבוססת בבית הספר.',
    'language_differentiatedResponseScore': 'אין ניתן מענה דיפרנציאלי לצרכים השונים של התלמידים בתחום השפה.',
    'math_basicSkillsMasteryScore': 'מיומנויות היסוד במתמטיקה אינן נשלטות היטב על ידי התלמידים.',
    'math_effectiveStrategiesScore': 'התלמידים אינם משתמשים באסטרטגיות יעילות לפתרון בעיות.',
    'math_optimalAnxietyCopingScore': 'בית הספר אינו מסייע לתלמידים להתמודד באופן מיטבי עם חרדת מתמטיקה.',
    'math_useOfVisualAidsScore': 'אין נעשה שימוש יעיל באמצעי המחשה וכלים טכנולוגיים בהוראת המתמטיקה.',
    'math_sufficientDifferentiationScore': 'ההוראה במתמטיקה אינה מותאמת לרמות השונות של התלמידים.',
    'math_linkToDailyLifeScore': 'ההוראה אינה מקשרת את המתמטיקה לחיי היומיום ואינה הופכת אותה לרלוונטית.',
    'english_studentsConfidentInUseScore': 'התלמידים אינם מרגישים בטוחים להשתמש בשפה האנגלית.',
    'english_exposureOutsideClassScore': 'התלמידים אינם נחשפים לשפה האנגלית גם מחוץ למסגרת השיעור.',
    'english_adaptedTeachingMethodsScore': 'שיטות ההוראה באנגלית אינן מותאמות וחדשניות.',
    'english_useOfTechnologicalToolsScore': 'אין נעשה שימוש יעיל בכלים טכנולוגיים לקידום לימודי האנגלית.',
    'english_groupSizeAllowsGrowthScore': 'גודל קבוצות הלימוד אינו מאפשר למידה וצמיחה מיטבית.',
    'english_useOfAuthenticMaterialsScore': 'אין נעשה שימוש בחומרים אותנטיים ומגוונים בהוראת האנגלית.',
    'science_sufficientLabEquipmentScore': 'ציוד המעבדה בבית הספר אינו מספק ואינו מאפשר למידה התנסותית.',
    'science_developedInquirySkillsScore': 'מיומנויות החקר של התלמידים אינן מפותחות היטב.',
    'science_practicalExperiencesScore': 'התלמידים אינם זוכים להתנסויות מעשיות רבות בשיעורי המדעים.',
    'science_developedScientificThinkingScore': 'ההוראה אינה מטפחת חשיבה מדעית, ביקורתית ויצירתית.',
    'science_updatedCurriculumScore': 'תוכנית הלימודים במדעים אינה מעודכנת לחזית הידע המדעי.',
    'science_linkToEnvironmentAndCommunityScore': 'הלמידה אינה מקשרת בין תכני המדעים לסביבה ולקהילה.',
    'pedagogyPlanning_knowledgeAndSkillsMappingScore': 'צוותי ההוראה אינם ממפים את הידע והמיומנויות הנדרשים בכל תחום.',
    'pedagogyPlanning_findingsTranslatedScore': 'ממצאי המיפוי אינם מתורגמים לתכנון הוראה מותאם לתלמידים.',
    'pedagogyPlanning_effectivenessReviewScore': 'אין מתקיימת בחינה מתמדת של אפקטיביות תכנון ההוראה.',
    'pedagogyPlanning_literacyPromotionEffortsScore': 'המאמצים לקידום אוריינות אינם שזורים בכל תחומי הדעת.',
    'pedagogyPlanning_entrepreneurshipAndInnovationCultureScore': 'אין קיימת תרבות של יזמות וחדשנות בתכנון ההוראה.',
    'pedagogyPractices_lessonsIncludeVarietyScore': 'השיעורים אינם כוללים מגוון של פעילויות המותאמות למטרות.',
    'pedagogyPractices_diverseLearningMethodsScore': 'אין נעשה שימוש בדרכי למידה מגוונות המעודדות מעורבות פעילה.',
    'pedagogyPractices_useOfDigitalToolsScore': 'אין נעשה שימוש מושכל בכלים דיגיטליים לשיפור ההוראה והלמידה.',
    'pedagogyPractices_differentiatedTeachingScore': 'ההוראה אינה דיפרנציאלית ואינה נותנת מענה אפקטיבי לשונות בין התלמידים.',
    'pedagogyPractices_teachingPromotesThinkingScore': 'ההוראה אינה מקדמת חשיבה ביקורתית, יצירתית ומעמיקה.',
    'pedagogyPractices_teachingLearningSkillsScore': 'ההוראה אינה מקנה לתלמידים מיומנויות למידה עצמאית.',
    'pedagogyFeedback_managedEvaluationProcessesScore': 'תהליכי ההערכה אינם מנוהלים באופן שיטתי ומקצועי.',
    'pedagogyFeedback_teachersHaveKnowledgeAndSkillsScore': 'למורים אין את הידע והמיומנויות להעריך את התלמידים באופן מהימן.',
    'pedagogyFeedback_feedbackAndReflectionProcessesScore': 'אין מתקיימים תהליכי משוב ורפלקציה המקדמים את למידת התלמידים.',
    'pedagogyFeedback_evaluationCriteriaScore': 'אין קיימים קריטריונים ברורים ושקופים להערכת הישגי התלמידים.',
    'pedagogyFlexibility_flexibleLearningOrganizationScore': 'ארגון הלמידה בבית הספר אינו גמיש ואינו מאפשר מגוון סביבות למידה.',
    'pedagogyFlexibility_focusedCurriculumScore': 'תוכנית הלימודים אינה ממוקדת ואינה מאפשרת למידה מעמיקה.',
    'pedagogyFlexibility_teachersHaveInterdisciplinaryKnowledgeScore': 'למורים אין ידע המאפשר למידה בין-תחומית ורב-תחומית.',
    'pedagogyCollaboration_jointPlanningRoutinesScore': 'אין קיימות שגרות של תכנון משותף בקרב צוותי המורים.',
    'pedagogyCollaboration_adaptedPracticesScore': 'פרקטיקות ההוראה אינן מותאמות ונבחנות באופן שוטף על ידי הצוות.',
    'pedagogyCollaboration_jointExaminationScore': 'אין מתקיימת בחינה משותפת של עבודות תלמידים להפקת תובנות.',
    'pedagogyCollaboration_openDialogueForImprovementScore': 'אין מתקיים שיח פתוח ומקצועי בין המורים במטרה לשפר את ההוראה.',
    'pedagogyCollaboration_opennessToLearningScore': 'הצוות אינו מפגין פתיחות ללמוד זה מזה ולשנות פרקטיקות.',
    'pedagogyCollaboration_beliefInAbilitiesScore': 'אין קיימת אמונה ביכולות המשותפות של הצוות להוביל לשיפור.',
    'communityContinuum_enrichmentProgramsOfferedScore': 'אין מוצעים תוכניות העשרה מגוונות לתלמידים.',
    'communityContinuum_tripsConnectedToCurriculumScore': 'הטיולים והפעילויות החוץ-בית-ספריות אינם מחוברים לתוכנית הלימודים.',
    'communityContinuum_diverseEducationalFrameworksScore': 'אין קיימים מסגרות חינוכיות מגוונות ומשלימות.',
    'communitySocial_socialEducationIsAdaptedScore': 'החינוך החברתי אינו מותאם לצרכים השונים של התלמידים.',
    'communitySocial_teachersHaveKnowledgeAndToolsScore': 'למורים אין את הידע והכלים להנחיית חינוך חברתי אפקטיבי.',
    'communitySocial_teachingAssistantsPotentialRealizedScore': 'הפוטנציאל של הסייעות החינוכיות אינו מנוצל במלואו.',
    'communityLeisure_collaborationsWithOrganizationsScore': 'אין קיימות שיתופי פעולה עם ארגונים ומוסדות בקהילה.',
    'communityLeisure_encouragementAndGuidanceForParticipationScore': 'אין מתקיימת עידוד והנחיה להשתתפות בפעילויות פנאי.',
    'communityLeisure_wideRangeOfActivitiesScore': 'אין מוצעת מגוון רחב של פעילויות פנאי וחוגים.',
    'communityPartnerships_parentParticipationInMeetingsScore': 'השתתפות ההורים במפגשים ופעילויות נמוכה.',
    'communityPartnerships_continuousCommunicationToFamiliesScore': 'אין מתקיימת תקשורת רציפה ומשמעותית עם המשפחות.',
    'communityPartnerships_parentsInvolvedInActivitiesScore': 'ההורים אינם מעורבים מספיק בפעילויות בית הספר.',
    'communityPartnerships_parentsHaveToolsToSupportScore': 'להורים אין כלים מספיקים לתמיכה בילדיהם.',
    'communityPartnerships_effectiveDialogueWithAuthorityScore': 'אין מתקיים שיח אפקטיבי עם הרשות המקומית.',
    'communityPartnerships_externalResourcesUtilizedScore': 'אין מנוצלים משאבים חיצוניים לטובת בית הספר.',
};
